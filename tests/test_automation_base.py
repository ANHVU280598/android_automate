...
@pytest.mark.test_is_element_present
def test_is_element_present(base):
    path = '//android.widget.TextView[@text="Kiếm Thưởng"]'
    result = base.is_element_present("XPATH", path)
    assert result is not None, f'Expect element to be present for XPATH {result}'
